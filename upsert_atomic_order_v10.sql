-- Fungsi Upsert Sale with Items (v10 - CORRECT PREFIX)
-- Memperbaiki awalan nomor invoice (HLD- untuk Pending, INV- untuk Paid)
...
BEGIN
  ...
  -- 2. Logika penomoran jika belum ada (HLD untuk Hold, INV untuk Paid)
