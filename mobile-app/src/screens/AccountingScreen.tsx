        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#f9fafb' }}>
            <StyledView className="flex-1 p-6">
                <StyledView className="flex-row items-center mb-6">
                    ...
                    <StyledText className="text-2xl font-bold text-gray-800">Modul Akuntansi</StyledText>
                </StyledView>
                ...
                <StyledView className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex-1 justify-center items-center">
                    ...
                    <StyledText className="text-lg font-semibold text-gray-800 mb-2">Fitur Belum Tersedia</StyledText>
                    <StyledText className="text-gray-500 text-center">
                        Modul akuntansi sedang dalam pengembangan. Silakan kembali lagi nanti.
                    </StyledText>
                </StyledView>
            </StyledView>
        </SafeAreaView>
