...
export function AuthProvider({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        const registerDeviceSession = async () => {
            ...
            // [FIX] Skip device fingerprinting/conflict check for Kiosk Mode or Public Display
            if (window.location.pathname.includes('/kiosk')) {
                console.log('[DeviceSession] Kiosk route detected, skipping session registration');
                return;
            }
            ...
            {sessionConflict && (
                <div className="fixed inset-0 z-[9999] bg-black/60 backdrop-blur-md flex items-center justify-center p-4">
                    <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 text-center animate-in zoom-in duration-300">
                        ...
                        <h2 className="text-2xl font-black text-gray-900 mb-2">Sesi Konflik</h2>
