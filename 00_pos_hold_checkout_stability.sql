-- =============================================================
-- POS HOLD + CHECKOUT STABILITY ROLLOUT
-- Jalankan file ini di Supabase SQL Editor untuk:
-- 1. Menambah kolom idempotency checkout
-- 2. Menambah konfigurasi nomor HOLD
-- 3. Mengaktifkan function upsert_sale_with_items versi stabil
-- =============================================================
