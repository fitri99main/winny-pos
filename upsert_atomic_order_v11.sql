-- Fungsi Upsert Sale with Items (v11 - EXACT MATCH WEB)
-- Menggunakan awalan HOLD- (bukan HLD-) sesuai dengan pengaturan sistem Web
...
BEGIN
  ...
  -- 2. Logika penomoran jika belum ada (HOLD untuk Pending, INV untuk Paid)
